...
function GraphPanelReposition($timeout, $document) {
	...
	function GraphPanelRepositionInner() {

	}

	GraphPanelRepositionInner.scope = true;

	GraphPanelRepositionInner.prototype.link = function (scope, element, attrs) {
	...
	var instance = new GraphPanelRepositionInner();
...
GraphPanelReposition.$inject = ['$timeout', '$document'];
