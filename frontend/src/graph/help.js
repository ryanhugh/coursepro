...
function Help($timeout) {
	...
	HelpInner.prototype.showInitialPrereqHelp = function (tree) {
	...
	HelpInner.prototype.activateHelpPopup = function (tree, x, y) {
	...
	HelpInner.prototype.addPrereqHelpToolips = function (tree) {
	...
	HelpInner.prototype.removeTooltips = function (tree) {
	...
	HelpInner.prototype.addPanelClickToExpand = function (tree) {
		if (localStorage.clickPopupHelpClicked) {
			return;
		};


		if (tree.isClass && !tree.$scope.isExpanded) {
	...
	HelpInner.prototype.addClickToExpand = function (tree) {
		if (localStorage.clickPopupHelpClicked) {
			return;
		};
	...
	HelpInner.prototype.go = function (tree) {
	...
	HelpInner.prototype.link = function (scope, element, attrs) {
